--[[  Neovim is part of your IDE. but what's exactly a IDE? It is not just some separated tasks? including: - search for files: C-f (:lua require('telescope.builtin').find_files()<cr>) --> fd under the hood - search for keywords: C-g (:lua require'telescope.builtin'.live_grep()<CR>) --> rg under the hood
