...
wk.register({
  ["<leader>l"] = { name = "+LSP" },
  ["<leader>lpd"] = { "<cmd>lua require('goto-preview').goto_preview_definition()<CR>", "preview definition" },
  ["<leader>lpt"] = { "<cmd>lua require('goto-preview').goto_preview_type_definition()<CR>", "preview type definition" },
  ["<leader>lpi"] = { "<cmd>lua require('goto-preview').goto_preview_implementation()<CR>", "preview implementation" },
  ["<leader>lpr"] = { "<cmd>lua require('goto-preview').goto_preview_references()<CR>", "preview refrence" },
  ["<leader>lpc"] = { "<cmd>lua require('goto-preview').close_all_win()<CR>", "close" },

  ["<leader>lsd"] = { ":lua require('telescope.builtin').lsp_document_symbols()<CR>", "document symbols" },
  ["<leader>lsw"] = { ":lua require('telescope.builtin').lsp_workspace_symbols()<CR>", "workspace symbols" },
  ["<leader>lsy"] = { ":lua require('telescope.builtin').lsp_dynamic_workspace_symbols()<CR>", "dynamic workspace symbols" },
  ["<leader>ldd"] = { "Telescope diagnostics bufnr=0<CR>", "document diagnostics" },
  ["<leader>ldw"] = { ":lua require('telescope.builtin').diagnostics()<CR>", "workspace diagnostics" },
  ["<leader>ldp"] = { "lua vim.lsp.diagnostic.goto_prev()<CR>", "diagnostic(goto prev)" },
  ["<leader>ldn"] = { ":lua vim.lsp.diagnostic.goto_next()<CR>", "diagnostics(goto next)" },

  ["<leader>lar"] = { ":lua require('telescope.builtin').lsp_range_code_actions()<CR>", "range code actions" },
  ["<leader>lan"] = { ":lua require('telescope.builtin').lsp_code_actions()<CR>", "normal code action" },
  ["<leader>lf"] = { ":lua require('telescope.builtin').lsp_type_definitions()<CR>", "type definition" },
  ["<leader>li"] = { ":lua require('telescope.builtin').lsp_implementations()<CR>", "implementation" },
  ["<leader>lr"] = { ":lua require('telescope.builtin').lsp_references()<CR>", "refrences" },

  ["<leader>lh"] = { "lua vim.lsp.buf.hover()<CR>", "hover" },
  ["<leader>lg"] = { "<cmd>lua vim.lsp.buf.signature_help()<CR>", "signature help" },
